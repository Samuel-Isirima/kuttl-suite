...
// ─────────────────────────────────────────────
// Selection types (click-to-select)
// ─────────────────────────────────────────────

export interface SelectedElement {
  uid: string;
  tag: string;
  description: string;       // data-description or inferred label
  computedStyles: Record<string, string>;  // key computed styles
  rect: DOMRect;
  classes: string[];
}
...
export interface InterceptConfig {
  root?: Element;
  uidAttribute?: string;
  descriptionAttribute?: string;   // defaults to 'data-description'
  skipTags?: string[];
  persistKey?: string;
  debug?: boolean;
  ai?: AIProviderConfig;
  onSelect?: (el: SelectedElement | null) => void;  // click-to-select callback
