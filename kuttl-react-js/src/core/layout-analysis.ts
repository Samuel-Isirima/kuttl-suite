    ...
    if (context.parentDisplay.includes("grid")) {
      ...
      if (parent) {
        ...
        additionalPatches.push({
          ...
          payload: {
            styles: {
              // This would need more sophisticated logic to determine the correct grid adjustment
              gridTemplateColumns: "auto", // Placeholder - needs proper grid column removal
            }
          }
        });
